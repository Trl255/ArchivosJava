...
import static ejercicio3.Metodos.entrada;
...
public class Metodos {
    ...
    static LocalDate pedirFecha(){
       ...
       static void borrarUsuario(HashSet <Socio> listado){
           String dni="";
       ...
       static void modificarUsuario(HashSet<Socio> listado){
       ...
       static void listarNombre(HashSet <Socio> usuarios){
           ArrayList <Socio> porNombre=new ArrayList<>();
           porNombre.addAll(usuarios);
           Collections.sort(porNombre,new ordenarPorNombre());
           Iterator it = porNombre.iterator();
           while(it.hasNext()){
