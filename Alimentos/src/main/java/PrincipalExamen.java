...
public class PrincipalExamen {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Vivienda> listaNueva = Arrays.stream(casas)
                .filter(e -> e.getNumeroHabitaciones() > 3)
                .collect(Collectors.toCollection(ArrayList::new));

        System.out.println("Viviendas con más de 3 habitaciones");
        ...
        if (comprobarNumero.trim().equalsIgnoreCase(buscar.getNumeroCatastral())) {
