...
/**
 Diseñar un programa que solicite al usuario una frase e indique, para cada letra 
 * que aparece en la frase, cuántas veces se repite. Las letras mayúsculas y 
 * minúsculas se consideran iguales a la hora de realizar la cuenta
 */
package tema_6;
